...
def migrate_vm(request, tenant_id):
    ...
    template_dir = 'vms_manage/migrate' 
        
    if request.GET.get('format', 'html') == 'csv':
        template_name = '%s/migrate.csv' % template_dir
        mimetype = "text/csv"
    else:
...
@login_required
def migrate(request, tenant_id=None):
    return migrate_vm(request, None)
